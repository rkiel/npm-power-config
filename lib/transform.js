...
function namespacePowerObject(namespace) {
  return { namespace };
}

function defaultPowerObject() {
  return { type: 'string' };
}

function inputPowerObject(object) {
  let input;
...
function handleScalarValue(value, namespace) {
  return lib.toPowerObjects(lib.scalarValueToPowerObject(value), namespace);
}

function scalarValueToPowerObject(value) {
...
function objectToPowerObject(object, namespace) {
  return _.assign(
    {},
    lib.defaultPowerObject(),
    lib.namespacePowerObject(namespace),
    lib.inputPowerObject(object),
    lib.scalarValueToPowerObject(object.value),
    object
  );
}
...
function toPowerObjects(object, namespace) {
  const powerObject = lib.objectToPowerObject(object, namespace);
...
lib = {
  ...
  handleUnknownValue,
  handleScalarValue,
  scalarValueToPowerObject,
  defaultPowerObject,
  namespacePowerObject,
  stringToPowerObject,
